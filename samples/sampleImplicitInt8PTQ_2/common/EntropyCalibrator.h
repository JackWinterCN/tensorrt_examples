...
public:
    ...
    {
        std::cout << "--------------- [info] EntropyCalibratorImpl<...>::readCalibrationCache()" << std::endl;
        ...
        std::cout << "--------------- [info] EntropyCalibratorImpl<...>::readCalibrationCache() cache size: " << length << std::endl;
        return length ? mCalibrationCache.data() : nullptr;
    }

    void writeCalibrationCache(const void* cache, size_t length) noexcept
    {
        std::cout << "--------------- [info] EntropyCalibratorImpl<...>::writeCalibrationCache()" << std::endl;
