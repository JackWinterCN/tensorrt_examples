...
class AveragePlugin final : public nvinfer1::IPluginV2DynamicExt
{
public:
    AveragePlugin() = delete;
    AveragePlugin(int32_t axis);
    AveragePlugin(void const* serialData, size_t serialLength);
    ~AveragePlugin() override;
...
class AveragePluginCreator : public nvinfer1::IPluginCreator
{
public:
    AveragePluginCreator();

    ~AveragePluginCreator() override = default;
